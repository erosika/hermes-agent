...
_SKIN_THEMES: Dict[str, Dict[str, str]] = {
    ...
    # Persona skins — palette mirrors the color values in hermes_cli/skin_payloads/*/mod.py
    # so that /skin:toggle and color theming work across all named skins.
    "ares": {
        "input-area": "#F1E6CF",
        "placeholder": "#6E584B italic",
        "prompt": "#F1E6CF",
        "prompt-working": "#6E584B italic",
        "hint": "#6E584B italic",
        "spinner": "#C7A96B",
        "input-rule": "#9F1C1C",
        "image-badge": "#C7A96B bold",
        "completion-menu": "bg:#1A1513 #F1E6CF",
        "completion-menu.completion": "bg:#1A1513 #F1E6CF",
        "completion-menu.completion.current": "bg:#241B18 #DD4A3A",
        "completion-menu.meta.completion": "bg:#1A1513 #6E584B",
        "completion-menu.meta.completion.current": "bg:#241B18 #C7A96B",
        "clarify-border": "#9F1C1C",
        "clarify-title": "#DD4A3A bold",
        "clarify-question": "#F1E6CF bold",
        "clarify-choice": "#6E584B",
        "clarify-selected": "#DD4A3A bold",
        "clarify-active-other": "#DD4A3A italic",
        "clarify-countdown": "#9F1C1C",
        "sudo-prompt": "#DD4A3A bold",
        "sudo-border": "#9F1C1C",
        "sudo-title": "#DD4A3A bold",
        "sudo-text": "#F1E6CF",
        "approval-border": "#9F1C1C",
        "approval-title": "#DD4A3A bold",
        "approval-desc": "#F1E6CF bold",
        "approval-cmd": "#6E584B italic",
        "approval-choice": "#6E584B",
        "approval-selected": "#DD4A3A bold",
        "banner-border": "#9F1C1C",
        "banner-title": "#DD4A3A",
        "banner-accent": "#C7A96B",
        "banner-dim": "#6E584B",
        "banner-text": "#F1E6CF",
        "ui-accent": "#DD4A3A",
        "ui-label": "#C7A96B",
    ...
    "posideon": {
        "input-area": "#EAF7FF",
        "placeholder": "#6FA6C8 italic",
        "prompt": "#EAF7FF",
        "prompt-working": "#6FA6C8 italic",
        "hint": "#6FA6C8 italic",
        "spinner": "#A9DFFF",
        "input-rule": "#2A6FB9",
        "image-badge": "#A9DFFF bold",
        "completion-menu": "bg:#091320 #EAF7FF",
        "completion-menu.completion": "bg:#091320 #EAF7FF",
        "completion-menu.completion.current": "bg:#10263A #5DB8F5",
        "completion-menu.meta.completion": "bg:#091320 #6FA6C8",
        "completion-menu.meta.completion.current": "bg:#10263A #A9DFFF",
        "clarify-border": "#2A6FB9",
        "clarify-title": "#5DB8F5 bold",
        "clarify-question": "#EAF7FF bold",
        "clarify-choice": "#6FA6C8",
        "clarify-selected": "#5DB8F5 bold",
        "clarify-active-other": "#5DB8F5 italic",
        "clarify-countdown": "#2A6FB9",
        "sudo-prompt": "#5DB8F5 bold",
        "sudo-border": "#2A6FB9",
        "sudo-title": "#5DB8F5 bold",
        "sudo-text": "#EAF7FF",
        "approval-border": "#2A6FB9",
        "approval-title": "#5DB8F5 bold",
        "approval-desc": "#EAF7FF bold",
        "approval-cmd": "#6FA6C8 italic",
        "approval-choice": "#6FA6C8",
        "approval-selected": "#5DB8F5 bold",
        "banner-border": "#2A6FB9",
        "banner-title": "#5DB8F5",
        "banner-accent": "#A9DFFF",
        "banner-dim": "#6FA6C8",
        "banner-text": "#EAF7FF",
        "ui-accent": "#5DB8F5",
        "ui-label": "#A9DFFF",
    ...
    "sisyphus": {
        "input-area": "#F5F5F5",
        "placeholder": "#919191 italic",
        "prompt": "#F5F5F5",
        "prompt-working": "#919191 italic",
        "hint": "#919191 italic",
        "spinner": "#D3D3D3",
        "input-rule": "#B7B7B7",
        "image-badge": "#D3D3D3 bold",
        "completion-menu": "bg:#0F0F0F #F5F5F5",
        "completion-menu.completion": "bg:#0F0F0F #F5F5F5",
        "completion-menu.completion.current": "bg:#171717 #E7E7E7",
        "completion-menu.meta.completion": "bg:#0F0F0F #919191",
        "completion-menu.meta.completion.current": "bg:#171717 #D3D3D3",
        "clarify-border": "#B7B7B7",
        "clarify-title": "#E7E7E7 bold",
        "clarify-question": "#F5F5F5 bold",
        "clarify-choice": "#919191",
        "clarify-selected": "#E7E7E7 bold",
        "clarify-active-other": "#E7E7E7 italic",
        "clarify-countdown": "#B7B7B7",
        "sudo-prompt": "#E7E7E7 bold",
        "sudo-border": "#B7B7B7",
        "sudo-title": "#E7E7E7 bold",
        "sudo-text": "#F5F5F5",
        "approval-border": "#B7B7B7",
        "approval-title": "#E7E7E7 bold",
        "approval-desc": "#F5F5F5 bold",
        "approval-cmd": "#919191 italic",
        "approval-choice": "#919191",
        "approval-selected": "#E7E7E7 bold",
        "banner-border": "#B7B7B7",
        "banner-title": "#E7E7E7",
        "banner-accent": "#D3D3D3",
        "banner-dim": "#919191",
        "banner-text": "#F5F5F5",
        "ui-accent": "#E7E7E7",
        "ui-label": "#D3D3D3",
