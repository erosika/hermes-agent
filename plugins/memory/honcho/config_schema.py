...
CONFIG_SCHEMA = ProviderConfigSchema(
    ...
    fields=(
        ...
        ProviderField(
            ...
            label="Search top-k",
            kind=KIND_NUMBER,
            description="Conclusions returned for the semantic search query (1-100). Blank uses the Honcho default.",
            placeholder="(Honcho default)",
            group="Recall",
        ),
        ProviderField(
            ...
            kind=KIND_NUMBER,
            description="Semantic distance cutoff for search results, 0.0-1.0. Lower is stricter. Blank uses the Honcho default.",
            placeholder="(Honcho default)",
            group="Recall",
        ),
        ProviderField(
            ...
            kind=KIND_NUMBER,
            description="Cap on conclusions included in the peer representation (1-100). Blank uses the Honcho default.",
            placeholder="(Honcho default)",
            group="Recall",
        ),
        ProviderField(
